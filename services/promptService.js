...
### 비교 가이드:
1. **핵심 차이점 2-3개** 우선 언급 (데이터량, 가격, 혜택 등)
2. **적합 사용자** 명확히 추천
3. **3-4문장 요약**, 리스트 형태(-, •) 사용 금지, 설명하듯이 요약 
4. 중요 키워드는 **굵은 글씨**로 강조
5. 모든 요금제명은 **굵게** 표시

### 예시 톤:
"두 요금제의 가장 큰 차이는 **데이터 제공량** 과 **월 요금** 에 있어요. **5G 프리미어 플러스**는 데이터 무제한 + 넷플릭스 혜택을 원하는 분께, **5G 스탠다드** 는 합리적 가격으로 충분한 데이터를 쓰고 싶은 분께 적합해요! 😊"`;
